        ...
        <div class="contain items-center justify-center">
          <div class="inner">
            <div class="flex-1">
              ...
              <div class="mt-[15px]">
                <div
                  class="flex item5 flex-col items-start justify-start w-full"
                >
                  ...
                  >
                    <template #empty>
                      <div
                        class="flex items-center justify-center flex-col images-empty"
                        @click="triggerUpload"
                      >
                        <img
                          :src="CloudUpload"
                          class="w-[30px] images-upload-icon"
                        />

                        <p class="mt-[10px]">
                          {{ t('drag_and_ddrop_files_to_here_to_upload') }}
                        </p>
                      </div>
                    </template>
                    <template
                    ...
                    >
                      <div
                        v-if="files.length > 0"
                        class="flex h-full images-wrap"
                      >
                        <div class="flex flex-row h-full gap-[10px]">
                          <div
                            v-for="(file, index) of files"
                            :key="file.name + file.type + file.size"
                            class="h-full image-group"
                          >
                            <img
                              class="image"
                              role="presentation"
...
const triggerUpload = () => {
  ...
  const value: any = imagesRef.value
  value.choose()
}
